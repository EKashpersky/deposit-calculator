      ...
      dot: {
        ...
        */
        theme: {
          replace: true,
          graph: {
            bgcolor: "#05182A",     /// general background
            fontsize: 16,
            color: "#1E90FF11",     /// folder border colour
            fontcolor: "#1460AA",   /// folder name text colour
            fillcolor: "#1E90FF11", /// folder background colour
            fontname: 'Helvetica',
            rankdir: "TD",
            splines: "ortho",
            shape: 'box',           /// folder representation shape
            style: 'rounded,filled' /// folder style
          },
          node: {
            color: "#0A3055",       /// file border colour
            fillcolor: "#0A3055",   /// file background colour
            fontname: 'Helvetica',
            fontcolor: "#1E90FF",   /// file text colour
            fontsize: 14,
            height: 0.5,
            shape: 'box',
...
// generated: dependency-cruiser@16.3.1 on 2024-05-03T15:15:12.156Z
